...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 21-Jan-2021 às 05:10
...
--
-- Estrutura da tabela `category_names`
--

DROP TABLE IF EXISTS `category_names`;
CREATE TABLE IF NOT EXISTS `category_names` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name_category` varchar(220) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `nome`, `cpf`, `data_nascimento`, `email`, `telefone`, `endereco`, `cidade`, `estado`, `created`, `modified`) VALUES
(1, 'Raphael silva', '77685269718', '25/04/1960', 'emailtest@gmail.com', '2185479135', 'rua das palmeiras 83 ', 'rio de janeiro', 'rio de janeiro', '2021-01-20 13:13:26', NULL),
(3, 'maria', '85774296755', '11/05/1995', 'raitoyagamij18@gmail.com', '2125697855', 'Rua embaixador romero brito jr 159', 'São paulo', 'Campinas', '2021-01-21 03:22:19', '2021-01-21 03:22:19');
COMMIT;
